...
public class Exceldatadriven2  extends GenericMethods{
...
/*
		List<WebElement> webele = driver.findElements(By.tagName("tr"));
		for (WebElement webElement1 : webele) {
			System.out.println("###############");
			System.out.println(webele.size());

			String currentrowdata = webElement1.getText();
			String reqtxt="9999999997";
			System.out.println(currentrowdata);
			if(currentrowdata.contains(reqtxt)) {
				driver.findElement(By.xpath("//div[@class='remove']")).click();
				break;
			}
			//System.out.println("getTextmethod: "+webElement1.getText());
			System.out.println("webelement is: "+webElement1);
			
			System.out.println("@@@@@@@@@@@@"+driver.findElement(By.xpath("(//tbody/tr/td[4])[9]")).getText());
					
		}
*/
		
		WebElement noofentries = driver.findElement(By.xpath("//div[@class=\"dataTables_info\"]"));
		String strele = noofentries.getText();
		System.out.println("trying to know how many elements are present: "+strele);
